...
export default function CheckoutPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 p-4 sm:p-6 mt-20">
            ...
            {cartItems.length === 0 ? (
              ...
              <>
                {cartItems.map((item) => (
                  <div
                    key={item.id}
                    className="flex items-center gap-4 border rounded-lg p-3 bg-gray-50 hover:shadow-sm transition"
                  >
                    <Image
                      src={item.image}
                      alt={item.title}
                ...
                <div className="text-right text-lg font-semibold pt-3 border-t">
                  Total:{" "}
